    ...
    def test_single_socket_single_core_no_hyperthreading(self):
        ...
        valid_dict = { 
            "0": {
                ...
                "flags": "fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat pse36 clflush mmx fxsr sse sse2 syscall nx rdtscp lm constant_tsc rep_good nopl xtopology nonstop_tsc pni pclmulqdq monitor ssse3 cx16 sse4_1 popcnt xsave avx rdrand hypervisor lahf_lm".split(),
        ...
        # convert the OrderedDicts to regular dicts for easier diff"ing on errors
